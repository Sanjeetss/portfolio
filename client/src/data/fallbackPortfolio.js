export const fallbackPortfolio = {
  about: {
    ...
    title: 'AI Engineer',
    bio: 'AI Engineer specializing in converting research prototypes into scalable, production-grade ML and LLM solutions. Experienced in NLP, Computer Vision, model deployment, and cloud-native AI systems across AWS and GCP, with a strong focus on end-to-end ML pipelines and reusable AI components.'
  },
  projects: [
    {
      id: 1,
      ...
      tech_stack: 'Python, Computer Vision, Deep Learning, Full-Stack Development',
      github_link: null,
      live_link: null
    },
    {
...
export const normalizePortfolioData = (payload) => ({
  ...
  skills:
    payload.skills && Object.keys(payload.skills).length > 0
      ? payload.skills
